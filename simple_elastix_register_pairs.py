...
def register_pairs():
    ...
    for img_filename in files:
        ...
        # Create the results folders
        if not os.path.exists("results/results_pairs/backward_" + str(t)):
            os.mkdir("results/results_pairs/backward_" + str(t))
        if not os.path.exists("results/results_pairs/forward_" + str(t-1)):
            os.mkdir("results/results_pairs/forward_" + str(t-1))
        ...
        if t > 1000:
            ...
            output_directory = "results/results_pairs/backward_" + str(t)
            result_image = register_command(moving_image_filename, fixed_image_filename, output_directory)
            np.savez("results/npz/t" + str(t) + "_backward.npz", result_image)
            ...
            output_directory = "results/results_pairs/forward_" + str(t-1)
            result_image = register_command(moving_image_filename, fixed_image_filename, output_directory)
            np.savez("results/npz/t" + str(t-1) + "_forward.npz", result_image)
